      ...
      <div className="p-4 space-y-4">
        ...
        <div className="grid grid-cols-3 gap-2 text-center border-b border-border-light dark:border-border-dark pb-4">
          <div>
            ...
            <div className="text-[10px] uppercase text-text-secondary-light dark:text-text-secondary-dark mt-0.5">Đông Phương</div>
          </div>
          <div className="border-l border-r border-border-light dark:border-border-dark">
            ...
            <div className="text-[10px] uppercase text-text-secondary-light dark:text-text-secondary-dark mt-0.5">Tây Phương</div>
          </div>
          <div>
            <div className={`text-sm font-bold ${getScoreColor(result.vedicScore)}`}>
              {Math.round(result.vedicScore)}
            </div>
            <div className="text-[10px] uppercase text-text-secondary-light dark:text-text-secondary-dark mt-0.5">Ấn Độ (Vedic)</div>
          </div>
        </div>
        ...
        <div className="space-y-2 text-sm text-text-primary-light dark:text-text-primary-dark">
          ...
          {result.reason && (
            <div className="flex justify-between gap-4">
              <span className="text-text-secondary-light dark:text-text-secondary-dark whitespace-nowrap">Đánh giá</span>
