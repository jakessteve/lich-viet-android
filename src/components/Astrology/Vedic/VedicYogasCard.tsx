      ...
      <div className="flex items-center justify-between gap-2 border-b border-border-light/50 pb-3 dark:border-border-dark/50">
        <div>
          ...
          <p className="text-[11px] text-text-secondary-light dark:text-text-secondary-dark">
            Cấu trúc tương tác hành tinh gắn liền với Cung Vị (Bhavas), phẩm chất và thời vận kích hoạt
          </p>
        </div>
        <span className="rounded-full bg-emerald-500/10 px-2.5 py-0.5 text-xs font-bold text-emerald-700 dark:text-emerald-300 shrink-0">
            ...
            >
              ...
              <div className="pt-2 border-t border-border-light/40 dark:border-border-dark/40 space-y-1.5 text-micro">
                <div className="flex flex-wrap gap-1 items-center">
                  ...
                  {item.isCombust && (
                    <span className="rounded bg-rose-500/15 text-rose-700 dark:text-rose-300 px-1.5 py-0.5 font-bold">
                      Thiêu Đốt (Astangata)
                    </span>
                  )}
                </div>
