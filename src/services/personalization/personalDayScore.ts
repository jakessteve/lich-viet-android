...
export const isLucHop = (chi1: Chi, chi2: Chi): boolean => {
...
export const isTuongXung = (chi1: Chi, chi2: Chi): boolean => {
...
export const isTuongHai = (chi1: Chi, chi2: Chi): boolean => {
...
export const isTuongHinh = (chi1: Chi, chi2: Chi): boolean => {
...
/** Calculate the Personal Day Score based on birth year and the day's Chi or Can Chi string.
